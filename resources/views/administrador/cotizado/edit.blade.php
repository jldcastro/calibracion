                ...
                <div class="col-md-12">
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">Valorizar solicitud de cotización</h3>
                        </div>
                        <div class="box-body">
                ...
                <table class="basculas">
                    ...
                    <tbody id="tbody">
                        @foreach($bascula as $bas)
                            <tr class="bascula">
                                <th><input type="text" class="form-control input cantidad" style="width: 75px; text-align: center;" disabled value="{{$bas->cantidad}}"></th>
                                ...
                                <th><input type="text" class="form-control input v_unitario" name="v_unitario[]" style="width: 100px; text-align: center; " value="{{  $bas->unitario }}"></th>
                                <td><input type="text" class="form-control input subtotal" name="subtotal[]" id="subtotal" value="{{$bas->subtotal}}" style="width: 100px; text-align: center;"></td>
                            </tr>
                        @endforeach
                        ...
                        <tfoot>
                            <tr class="bascula">
                                ...
                                <th></th>
                                <th><b>TOTAL</b></th>
                                <th><input type="text" class="totalbas" name="totalbas" style="width: 100px; text-align: center" disabled value="{{ $f37->subtotal }}"></th>
                            </tr>
                        </tfoot>
                    </table>
...
@if ($errors->has('compra'))
                                    ...
                                    <span class="help-block">
                                        <p style="color: red;">{{ $errors->first('compra') }}</p>
                                    </span>
            ...
            <div class="box-footer">
              ...
              <button type="button" class="btn btn-danger btn-flat col-md-offset-5"><a href="{!! URL::to('/cotizado') !!}" style="color: #ffffff">Atrás</a></button>
...
@section('scripts')
    ...
    {!!Html::script('js/suma2.js')!!}
    {!!Html::script('js/suma3.js')!!}
    {!!Html::script('js/suma4.js')!!}
@endsection
